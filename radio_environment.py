...
HeightMapMatrix = np.zeros(shape=(D * step, D * step))  #大小为什么是这样的？？？
...
# =============Define the BS Distribution=======================可以改写为车辆的分布
BS_loc = np.array(
    [[1, 1, 0.025], [1.5774, 1.333, 0.025], [1, 1.6667, 0.025, ], [0.4226, 1.3333, 0.025], [0.4226, 0.6667, 0.025],
