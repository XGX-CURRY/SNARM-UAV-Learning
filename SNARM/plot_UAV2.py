...
X_vec = npzfile['arr_1']
Y_vec = npzfile['arr_2']
result_DDQN_snr2 = np.load('SNARM_main_Results.npz', allow_pickle=True)
...
plt.savefig(fname='scheme1uav2.jpg',path='D:\PycharmProjects\SNARM-UAV-Learning\TEST_plot2',dpi=600)
plt.show()