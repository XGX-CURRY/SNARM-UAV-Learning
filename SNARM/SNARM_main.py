...
from SNARM import radio_environment as rad_env
from SNARM.radio_mapping import RadioMap  # the radio map class
...
np.savez('SNARM_main_Results.npz', return_mov_avg, ep_rewards, ep_trajecotry)
