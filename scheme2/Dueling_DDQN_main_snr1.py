...
# plt.show()
fig.savefig('trajectoriesNoMapping_snr1.eps')
fig.savefig('trajectoriesNoMapping_snr1.pdf')
fig.savefig('trajectoriesNoMapping_snr1.jpg')

print('{}/{} episodes reach terminal'.format(ep_reach_terminal.count(True), episode))

# Save the simulation ressult
np.savez('Dueling_DDQN_main_Results_snr1.npz', return_mov_avg, ep_rewards, ep_trajecotry)
