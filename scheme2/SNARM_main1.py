...
MAX_STEP = 100  # maximum number of time steps per episode
...
np.savez('MSE1',ep_MSE)
fig = plt.figure(60)
plt.plot(np.arange(len(ep_MSE)) + 1, ep_MSE, 'b-', linewidth=2)
plt.grid(which='major', axis='both')
plt.xlabel('Episode')
plt.ylabel('MSE')
fig.savefig('MSE1.eps')
fig.savefig('MSE1.pdf')
fig.savefig('MSE.jpg')

np.savez('MAE1',ep_MAE)
fig = plt.figure(70)
plt.plot(np.arange(len(ep_MAE)) + 1, ep_MAE, 'b-', linewidth=2)
plt.grid(which='major', axis='both')
plt.xlabel('Episode')
plt.ylabel('MAE')
fig.savefig('MAE1.eps')
fig.savefig('MAE1.pdf')
fig.savefig('MAE1.jpg')

np.savez('Max_Absolute_Error1',ep_Max_Absolute_Error)
fig = plt.figure(80)
plt.plot(np.arange(len(ep_Max_Absolute_Error)) + 1, ep_Max_Absolute_Error, 'b-', linewidth=2)
plt.grid(which='major', axis='both')
plt.xlabel('Episode')
plt.ylabel('Maximum absolute eror')
fig.savefig('Max_Absolute_Error1.eps')
fig.savefig('Max_Absolute_Error1.pdf')
fig.savefig('Max_Absolute_Error1.jpg')

np.savez('Bin_cross_entr1',ep_bin_cross_entr)
fig = plt.figure(90)
plt.plot(np.arange(len(ep_bin_cross_entr)) + 1, ep_bin_cross_entr, 'b-', linewidth=2)
plt.grid(which='major', axis='both')
plt.xlabel('Episode')
plt.ylabel('Binary cross entropy')
fig.savefig('Bin_cross_entr1.eps')
fig.savefig('Bin_cross_entr1.pdf')
fig.savefig('Bin_cross_entr1.jpg')
...
# plt.ylim(-6000,0)
np.savez('return1',return_mov_avg)
fig.savefig('return1.eps')
fig.savefig('return1.pdf')
fig.savefig('return1.jpg')
...
plt.show()
fig.savefig('CoverageMapLearned1.eps')
fig.savefig('CoverageMapLearned1.pdf')
fig.savefig('CoverageMapLearned1.jpg')
...
plt.ylabel('y (meter)', fontsize=14)
plt.show()
fig.savefig('trajectoriesSNARM1.eps')
fig.savefig('trajectoriesSNARM1.pdf')
fig.savefig('trajectoriesSNARM1.jpg')
