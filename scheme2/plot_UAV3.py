...
X_vec = npzfile['arr_1']
Y_vec = npzfile['arr_2']
result_DDQN_snr2 = np.load('Dueling_DDQN_MultiStepLeaning_main_Results_100.npz', allow_pickle=True)
...
plt.savefig(fname='scheme2uav3.jpg',path='D:\PycharmProjects\SNARM-UAV-Learning\TEST_plot2',dpi=600)
plt.show()