...
import radio_environment2 as rad_env  # the actual radio environment
# 指定使用GPU
...
# plt.show()
fig.savefig('trajectoriesNoMapping_snr2.eps')
fig.savefig('trajectoriesNoMapping_snr2.pdf')
fig.savefig('trajectoriesNoMapping_snr2.jpg')

print('{}/{} episodes reach terminal'.format(ep_reach_terminal.count(True), episode))

# Save the simulation ressult
np.savez('Dueling_DDQN_main_Results_snr2.npz', return_mov_avg, ep_rewards, ep_trajecotry)
